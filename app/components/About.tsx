import photo from "@/public/assets/me.jpg";
...
const About = () => {
  return (
    <section
      id="about"
      className="w-full min-h-screen p-4 sm:p-8 md:p-16 lg:p-24 font-sans bg-slate-100 dark:bg-slate-700 text-black dark:text-white flex flex-col justify-center items-center"
    >
